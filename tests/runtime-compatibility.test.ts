...
test('all five live 5A 7.4 lessons pass canonical and compatibility gates with their verified source records', () => {
...
test('all five live lessons survive import projection, JSON save, full reload, and reopen data checks', () => {
  for (const source of [lesson1, lesson2, lesson3, lesson4, lesson5]) {
